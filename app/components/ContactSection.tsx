    ...
    <section id="contact" className="pt-24 md:py-32 md:pb-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-24">
          ...
          <div className="flex flex-col justify-between items-center md:items-start order-2 md:order-1">
            <FadeInView className="hidden md:block text-3xl md:text-4xl font-bold text-white">
              <h2>Get In Touch</h2>
            </FadeInView>
            <FadeInView
              delay={0.2}
              className="hidden md:block text-gray-100 text-xl leading-8 text-justify"
            >
              <p>
                I am always open to discussing new projects, creative ideas and
                opportunities; Currently available for full-time positions and
                select freelance projects that align with my expertise.
              </p>
            </FadeInView>
